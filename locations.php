         	...
         	<div class="col-lg-12">
                <div class="list-group">
                	<div class="list-group">
                      ...
                      <a href="javascript:google.maps.event.trigger(markerGroups['phag'][4],'click')" class="list-group-item">Columbia University Mailman School of Public Health</a>
                      ...
                      <a href="javascript:google.maps.event.trigger(markerGroups['phag'][8],'click')" class="list-group-item">Northwestern University Feinberg School of Medicine</a>
